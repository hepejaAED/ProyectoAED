...
knitr::opts_chunk$set(
  ...
  fig.align = "center" # Centra las figuras (opcional)
)
```
...
edades_1 <- c("16-19", "20-24", "25-29", "30-34")
edades_2 <- c("35-39", "40-44", "45-49", "50-54")
edades_3 <- c("55-59", "60-64", "65-69", "70+")
...
```{r, echo=FALSE}
datos_composicion_2024<- df_clean %>% 
  filter(Periodo==2024) %>% 
...
graficos_parados_proporcion_por_año<- lapply(años1, function(año){
df_clean %>%
  filter(Periodo==año) %>% 
  ...
  labs(
    title = paste("Distribución del paro por sexo -",año),
    x = "Grupo de edad",
...
plot_grid(
  plotlist = graficos_parados_proporcion_por_año[1:2],
  ncol = 2 # opcional
)
```
