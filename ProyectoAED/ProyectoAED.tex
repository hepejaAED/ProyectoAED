...
\tightlist
\item
  \textbf{Codificación e importación}: La codificación del los datos
  brutos es \texttt{UFT-8} con una confianza del \(100\%\). Archivo
  delimitado por tabulaciones, se indica que el separador decimal es la
  coma y que los valores \emph{NA} están codificados como \texttt{".."}
\end{itemize}

Las variables del dataframe original son Sexo, Edad, Relación con la
actividad económica, Periodo y Total.

\subsection{Valores faltantes}\label{valores-faltantes}

Los valores ausentes se encuentran concentrados \texttt{Total}
...
\pandocbounded{\includegraphics[keepaspectratio]{ProyectoAED_files/figure-latex/unnamed-chunk-12-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{ProyectoAED_files/figure-latex/unnamed-chunk-18-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{ProyectoAED_files/figure-latex/unnamed-chunk-18-2.pdf}}
